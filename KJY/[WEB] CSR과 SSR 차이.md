...
![kakao.png](https://github.com/fake-developers/1st/tree/KJY-01/KJY/resources/kakao.png)

* 페이지 소스 코드에 콘텐츠 정보 없음

* 그렇다면 어떻게 화면이 그려졌을까? -> JavaScript로 그려짐

  > ![js.png](https://github.com/fake-developers/1st/tree/KJY-01/KJY/resources/js.png)
...
![naver.png](https://github.com/fake-developers/1st/tree/KJY-01/KJY/resources/naver.png)
